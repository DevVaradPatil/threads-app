...
async function RightSidebar() {
    ...
    return (
        <section className="custom-scrollbar rightsidebar w-[25vw]">
            <div className="flex flex-1 flex-col justify-start">
                <h3 className="text-heading4-medium text-light-1 text-center">Newest Communities</h3>
                {communities.communities.map((community)=>(
                    ...
                    <Image src={community.image} alt="user image" width={22} height={22} className="rounded-full"/>
            ...
            <div className="flex flex-1 flex-col justify-start">
                <h3 className="text-heading4-medium text-light-1 text-center">Newest Users</h3>
